    ...
    public class LoadingContent
    {
        ...
        public static Dictionary<string, Noeud> LoadingNoeuds()
        {
            ...
            var dicnoeud = new Dictionary<string, Noeud>()
            {
                ...
                {"Taxi", new Noeud("\nVous avancez jusqu'au boulevard et vous appelez un taxi !!. En vitesse, vous embarquez. le taxi." +
                ...
                //#03  Marche  -- Combat
                {"Sentier", new Noeud("\nVous marchez dans le sentier et après quelques minutes, vous arrivez devant une\n" +
                ...
                //#04  
                {"Racine", new Noeud("\nVous arrivez à la hauteur de la rue Racine et vous tournez à gauche. " +
                ...
                //#05  
                {"Boul.Université", new Noeud("\nAprès un peu plus de 200m la taxi tombe en panne. Vous regardez le chauffeur\n" +
                ...
                //#07 
                {"Terrain Vague", new Noeud("\nVous vous diriger vers la droite où vous suivez le chemin de pierre.\n" +
                ...
                //#08 -- Combat
                {"Arrêter", new Noeud("\nVous sortez du taxi et vous vous avancer vers l'homme d'un pas très prudent. Arrivé à" +
                ...
                //#09
                {"Continuer", new Noeud("\nVous criez au chauffeur de pas s'arrêter ou vous lui trancherez la gorge sans hésitez." +
                ...
                //#10 Combat
                {"Argumente", new Noeud("\nVous sortez tous les deux du taxi et vous lui criez qu'il n'est qu'un imbécile!!!", null, perso6, true,
                        new Dictionary<int, string>()
                        {
                ...
                //#11  
                {"Escalier", new Noeud("\nVous traversez le terrain vague sans être répérer. Vous apercevez un escalier en très mauvaise" +
                ...
                //#12
                {"La Marjolaine", new Noeud("\nVous sautez à bord du bateau, et après quelques recherches, vous rendez compte\n" +
                ...
                //#13
                {"Derive", new Noeud("\nLe bateau n'était pas amarré et pendant la bagarre, vous avez dérivé.\n" +
                ...
                //#14
                {"Vers La Cathedrale", new Noeud("\nSur le chemin de la Cathédrale, vous atteingnez enfin le haut de la colline,\n" +
                ...
                //#15   
                {"Vous tentez de redemarrer le taxi", new Noeud("\nVous tentez de redémarrer le taxi par vous même. Lorsque vous apercevez le chauffeur" +
                ...
                //#16  
                {"A pied", new Noeud("\nN'ayant pas de temps à perdre vous continuez votre route en direction de votre objectif sur la rue" +
                ...
                //#17   
                {"Hotel", new Noeud("\nVous entrez dans l'hotel et vous arrivez dans le vestibule de l'hotel.  Les 2 barbares ont disparus." +
                ...
                //#18
                {"Etage", new Noeud("\nVous montez à l'étage par l'escalier. Malheureusement pour vous, on vous y attendait" +
                ...
                //#19
                {"Porte de derrière", new Noeud("\nAprès avoir traversé le halle de l'hotel, vous arrivez au couloir. ", null,perso4, true,
                        new Dictionary<int, string>()
                        {
                            { 1,"Cour de l'hotel"},
                ...
                //#20  
                {"Cour de l'hotel", new Noeud("\nVous ouvrez la porte de l'hotel et vous voilà tout prêt de votre objectif. Vous vous rendez tout" +
                ...
                //#21  
                {"Traversez la rue", new Noeud("\nVous attendez que la rue soit déserte, et vous vous lancez en direction de la " +
                ...
                //#22
                {"Entrez dans la Cathedrale", new Noeud("\nVous arrivez devant la Cathédrale et vous entrer par la seule issue encore" +
